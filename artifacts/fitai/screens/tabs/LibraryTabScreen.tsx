              ...
              {expandedWorkout === workout.id && (
                <View style={[styles.expandedContent, { backgroundColor: colors.card, borderColor: colors.border }]}>
                  ...
                  <TouchableOpacity
                    ...
                    style={[styles.openWorkoutBtn, { backgroundColor: colors.card, borderColor: colors.border }]}
                  >
                    <Ionicons name="play-outline" size={16} color={colors.foreground} />
                    <Text style={[styles.openWorkoutBtnText, { color: colors.foreground }]}>Open workout</Text>
                  </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  openWorkoutBtnText: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
