...
import { useSocial, SocialPost, Audience } from "@store/SocialContext";
...
const styles = StyleSheet.create({
  ...
  avatarCircle: { width: 90, height: 90, borderRadius: 30, alignItems: "center", justifyContent: "center", borderWidth: 2, position: "relative" },
