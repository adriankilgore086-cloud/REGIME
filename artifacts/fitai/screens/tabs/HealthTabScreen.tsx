      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: 120 }]} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.chartCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <TouchableOpacity
            ...
            activeOpacity={0.75}
            onPress={() => router.push("/body-metrics" as any)}
            accessibilityRole="button"
            accessibilityLabel="Open body metrics details"
          >
            <View>
              <Text style={[styles.chartTitle, { color: colors.foreground }]}>Body Metrics</Text>
              <Text style={[styles.chartSub, { color: colors.mutedForeground }]}>Current snapshot · tap for chart</Text>
            </View>
