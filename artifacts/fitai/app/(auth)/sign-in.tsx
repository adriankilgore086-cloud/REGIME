...
export default function SignInScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setAuthError(e?.errors?.[0]?.longMessage || "Sign in failed. Check your email and password.");
    } finally {
    ...
    >
      ...
      >
        ...
        <View style={{ marginTop: 20, marginBottom: 32 }}>
          ...
          <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>Your regime awaits.</Text>
        </View>
