...
export default function CalendarScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: 190 }]} showsVerticalScrollIndicator={false}>
      ...
      <TouchableOpacity
        onPress={() => setShowAddModal(true)}
        style={[styles.libraryBtn, { backgroundColor: colors.card, borderColor: colors.border, bottom: insets.bottom + 76 }]}
        activeOpacity={0.9}
      >
...
const styles = StyleSheet.create({
  ...
  libraryBtn: { position: "absolute", left: 16, right: 16, height: 50, borderRadius: 16, borderWidth: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 },
